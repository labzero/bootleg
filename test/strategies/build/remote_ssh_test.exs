defmodule Bootleg.Strategies.Build.RemoteSSHTest do
  ...
  test "build", %{config: config, workspace_setup: workspace_setup} do
    ...
    assert_received({Bootleg.SSH, :download, [:conn, "workspace/_build/test/rel/bootleg/releases/1/bootleg.tar.gz", "/Users/sashavoynow/projects/bootleg/releases/bootleg-1.tar.gz", []]})
  end
end
